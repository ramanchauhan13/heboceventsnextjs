      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="mb-20">
          ...
          <div className="space-y-8 max-w-4xl mx-auto">
            ...
            {/* 2015 */}
            <div className="flex items-start gap-6">
              <div className="w-4 h-4 bg-gradient-to-r from-brand-primary to-brand-secondary rounded-full mt-2 flex-shrink-0" />
            ...
            {/* 2020 */}
            <div className="flex items-start gap-6">
              <div className="w-4 h-4 bg-gradient-to-r from-brand-accent to-brand-secondary rounded-full mt-2 flex-shrink-0" />
            ...
            {/* 2025 */}
            <div className="flex items-start gap-6">
              <div className="w-4 h-4 bg-gradient-to-r from-brand-secondary to-brand-primary rounded-full mt-2 flex-shrink-0" />
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-20">
          ...
          {/* Mission */}
          <div className="bg-gradient-to-br from-brand-primary/20 to-brand-secondary/20 rounded-3xl p-8 backdrop-blur-xl border border-brand-border">
        ...
        {/* Company Values */}
        <div className="bg-gradient-to-br from-brand-surface/50 to-brand-card/50 rounded-3xl p-12 backdrop-blur-xl border border-brand-border">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            {/* Innovation */}
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-r from-brand-accent to-brand-secondary rounded-full flex items-center justify-center mx-auto mb-4">
                <Zap className="w-8 h-8 text-brand-text" />
              </div>
